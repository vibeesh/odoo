...
latex_documents = [
  ('index', 'odoo-doc.tex', u'Odoo Documentation',
...
man_pages = [
    ('index', 'odoo-doc', u'Odoo Documentation',
     [u'OpenERP s.a.'], 1)
]
...
texinfo_documents = [
  ('index', 'OdooDocumentation', u'Odoo Documentation',
   u'OpenERP s.a.', 'OdooDocumentation', 'Documentation for Odoo.',
   'Miscellaneous'),
]
